...
export const TOTAL_SCORE = QUESTION_COUNT.mc * SCORE_PER_QUESTION.mc +
...
export const LEVEL_GAME_COLORS = {
    1: '#FF6B6B',
    2: '#4ECDC4',
    3: '#FFE66D',
    4: '#95E1D3',
...
export const STAR_THRESHOLDS = [0.6, 0.8, 1.0];
export const XP_THRESHOLDS = [0, 100, 250, 500, 800, 1200, 1800, 2500, 3500, 5000];
